...
#  end
  ...
  test "should post create" do
    make_user(:editor)
    post :create, { :person => { :sex => 'Sex' }, :person_name_0 => { :given_name => 'Given Name', :calling_name => 'Calling name', :surname => 'Surname' } }
  ...
  test "should post update" do
    make_user(:editor)
    @request.accept = "text/javascript"
    post :update, { :id => people(:person1).id, :person => { :sex => 'Sex' }, :person_name_0 => { :id => person_names(:person_name1).id, :given_name => 'Given Name', :calling_name => 'Calling name', :surname => 'Surname' }, :form => { :topName => people(:person1).object_name } }
    assert_response :success
  end
