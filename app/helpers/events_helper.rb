    ...
    capture do
      ...
      concat(application_attach_modifier(object, options) do
               ...
               unless event_dates.length == 0
                 parts.append(event_dates.collect{|o| link_to(o.one_line, o)}.join(" "))
               end
               ...
               unless people.length == 0
                 parts.append("med")
                 parts.append(people.collect{|o| link_to(o.one_line, o)}.join(" "))
               end
               addresses = related_objects[:addresses].reject{|a| a.object_name == parent.object_name }
               unless addresses.length == 0
                 parts.append("vid")
                 parts.append(addresses.collect{|o| link_to(o.one_line, o)}.join(" "))
               end
